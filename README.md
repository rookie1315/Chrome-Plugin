...
2. Start the local Whisper server:
   ...
   On Windows, you can also double-click `start-local-whisper.bat` in the project root. It will install missing Python dependencies once, then start the local Whisper server.
